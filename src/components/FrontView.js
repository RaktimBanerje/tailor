...
const FrontView = ({isActive, data, choice, setChoice, selectedItem, setSelectedItem}) => {
  return (
    <div id="view1" className={`theView ${isActive && 'active'}`}>
      ...
      <img id={5} rel="pantpockets" name="Diagonal-side Pocket" label type="pant" className="shirt_part custom-part" activestyle price={0} icon="suit-icon-Pant_Rounded_Pocket" src="https://www.oxfordtailor.com/customize/suit/media/men/generated_suit_images/pantpockets/style_2_view_1.png" />
      ...
      <img id={8} rel="pantcuff" name="No Cuffs" label type="pant" className="shirt_part custom-part" activestyle price={0} icon="icon-icon-109" src="https://www.oxfordtailor.com/customize/suit/media/men/generated_suit_images/pantcuff/2_style_1_view_1.png" />
      ...
      <img id={15} rel="style" name="Single breasted" label type="jacket" className="shirt_part custom-part" activestyle price={0} icon="icon-icon-40" src={selectedItem.jacket.style[choice.jacket.style]} />
      <img id={16} rel="sleeves" name="No" label type="jacket" className="shirt_part" activestyle price={0} icon src={selectedItem.jacket.sleeves} />
      <img id={17} rel="pockets" name="Regular Flap Pockets" label type="jacket" className="shirt_part custom-part" activestyle price={0} icon="icon-icon-55" src={selectedItem.jacket.pockets[choice.jacket.pockets]} />
      <img id={18} rel="fit" name="Slim Fit" label type="jacket" className="shirt_part custom-part" activestyle price={0} icon="icon-icon-32" src={selectedItem.jacket.fit[choice.jacket.fit]} />
      ...
      <img id={20} rel="breastpocket" name="breastpocket" label type="jacket" className="shirt_part" activestyle price={0} icon src={selectedItem.jacket.breastpocket} />
      <img id={21} rel="lapel" name="Notch Slim" label type="jacket" className="shirt_part custom-part" activestyle price={0} icon="icon-icon-44" src={selectedItem.jacket.lapel[choice.jacket.lapel]} />
      ...
      <img id={23} rel="threads" name="Match to fabric color" label type="jacket" className="shirt_part" activestyle price={0} icon src="https://www.oxfordtailor.com/customize/suit/media/men/generated_suit_images/threads/view_1.png" /><img id={24} rel="buttons" name="2 Buttons" label type="jacket" className="shirt_part custom-part" ng-src="https://www.oxfordtailor.com/customize/suit/media/men/generated_suit_images/buttons/1_styletype_1_style_2_view_1.png" err-src="https://www.oxfordtailor.com/customize/suit/media/default_tool_img/blank.png" activestyle price={0} icon="icon-icon-32" src="https://www.oxfordtailor.com/customize/suit/media/men/generated_suit_images/buttons/1_styletype_1_style_2_view_1.png" />
    </div>
  )
}
